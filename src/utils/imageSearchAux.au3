...
Func _WaitForImagesSearchArea($findImage, $waitSecs, $resultPosition, $x1, $y1, $right, $bottom, ByRef $x, ByRef $y, $tolerance, $transparency = 0)
	$waitSecs = $waitSecs * 1000
	$startTime = TimerInit()
	While TimerDiff($startTime) < $waitSecs
		For $i = 1 To $findImage[0]
			Sleep(100)
			If _ImageSearchArea($findImage[$i], $resultPosition, $x1, $y1, $right, $bottom, $x, $y, $tolerance, $transparency) Then
				Return $i
			EndIf
		Next
	WEnd
